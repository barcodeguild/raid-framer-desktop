...
object BattlerageDefinition : SkillTreeDefinition {
  ...
  override val skills = listOf(
    ...
    Skill(3, "Whirlwind Slash", 0.0, 12.0, false, listOf("Whirlwind Slash")), // no casting
    ...
    Skill(7, "Tiger Strike", 0.0, 18.0, false, listOf("Tiger Strike")), // no casting
    Skill(8, "Bondbreaker", 0.0, 18.0, false, listOf("Bondbreaker")),
    Skill(9, "Terrifying Roar", 0.0, 18.0, false, listOf("Terrifying Roar")),
    Skill(10, "Hammer Toss", 0.0, 29.0, false, listOf("Hammer Toss")), // no casting (gives puncture)
