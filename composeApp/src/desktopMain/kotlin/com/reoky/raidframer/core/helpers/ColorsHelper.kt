...
object RFColors {
  ...
  val deepTranquilityTeal = Color(0xFF00ACC1)
  val deedendDebuffRed = Color(0xFFEF5350)
  val throwDaggerAmber = Color(0xFFFFA726)
  val stunDeepRed = Color(0xFFC62828)
  val staggerBrown = Color(0xFF8D6E63)
  val petrificationGray = Color(0xFF90A4AE)
  val absorbLifeforceMagenta = Color(0xFFE040FB)
  val corrosiveBarrageLime = Color(0xFFCDDC39)
  val blindedByCrowsDark = Color(0xFF455A64)
  val mistSunderCyan = Color(0xFF00BCD4)
  val regularSunderOrange = Color(0xFFFF7043)
  val impaleImmunitySteel = Color(0xFF78909C)
  val protectiveWingsGold = Color(0xFFFFD54F)
  val courageousActionBright = Color(0xFFFFAB40)
  val manaBarrierBlue = Color(0xFF42A5F5)
  val reviveGhostWhite = Color(0xFFE0E0E0)
