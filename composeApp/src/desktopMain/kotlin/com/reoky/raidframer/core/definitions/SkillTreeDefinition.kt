...
val META_MELEE_SPECS = setOf<SpecType>(
  SpecType.ABOLISHER, SpecType.DARKRUNNER, SpecType.DUSKRAIDER, SpecType.DREADHUNTER, SpecType.DREADRUNNER, SpecType.DUSKDIRGE,
  SpecType.DUSK_DANCER, SpecType.FEARSTALKER, SpecType.FEAR_ARTIST, SpecType.FEAR_AVENGER, SpecType.FEAR_CONTROLLER,
  SpecType.FEAR_RESOLVER, SpecType.FEAR_REVOLUTIONIST, SpecType.FEAR_SAVIOR, SpecType.BLOODREAVER, SpecType.BLADE_DANCER
)
...
val META_MAGE_SPECS = setOf<SpecType>(
  SpecType.FANATIC, SpecType.DREADRUNNER, SpecType.SPIRITUALIST, SpecType.EQUALIZER, SpecType.REVENANT
)
val META_DANCER_SPECS = setOf<SpecType>(
  ...
  SpecType.GLAMOROUS_REVOLUTIONIST, SpecType.GLAMOROUS_SAVIOR, SpecType.COMEDIAN, SpecType.FEARFUL_FANATIC
)
