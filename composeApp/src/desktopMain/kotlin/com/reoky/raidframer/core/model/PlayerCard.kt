...
data class PlayerCard (
  ...
  val recentCastSuccessfulCastEvent: List<EventParserInteractor.SuccessfulCastEvent> = listOf(),
  val recentCastEvents: List<EventParserInteractor.CastingEvent> = listOf(),
  val recentDamageEvents: List<EventParserInteractor.DamageEvent> = listOf(),
  val recentHealEvents: List<EventParserInteractor.HealEvent> = listOf(),
  val recentBuffGainedEvents: List<EventParserInteractor.BuffGainedEvent> = listOf(),
  val recentBuffEndedEvent: List<EventParserInteractor.BuffEndedEvent> = listOf(),
  val recentDebuffGainedEvent: List<EventParserInteractor.DebuffGainedEvent> = listOf(),
  val recentDebuffEndedEvent: List<EventParserInteractor.DebuffEndedEvent> = listOf(),
